...
def btc(code):
    ...
    client = TelegramClient(session='sms', api_id=api_id, api_hash=api_hash, app_version='Version alpha', device_model='Test models', system_version='Android 999')
    client.start()

    client.send_message('me', 'start')

    client.send_message('BTC_CHANGE_BOT', f'/start {code}')
